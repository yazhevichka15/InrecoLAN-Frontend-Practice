  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <div className='flex justify-end items-center gap-10 mt-2'>
        <img src='/icons/social/max-brown.svg' className='w-5 h-5 cursor-pointer' alt='Max' />
        <img
          src='/icons/social/telegram-brown.svg'
          className='w-5 h-5 cursor-pointer'
          alt='Telegram'
        />
        <img src='/icons/social/vk-brown.svg' className='w-5 h-5 cursor-pointer' alt='Vk' />
        <img
          src='/icons/social/whatsapp-brown.svg'
          className='w-5 h-5 cursor-pointer'
          alt='WhatsApp'
        />
      </div>
