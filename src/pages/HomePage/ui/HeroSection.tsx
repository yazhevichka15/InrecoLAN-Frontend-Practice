...
export const HeroSection: React.FC = () => {
  return (
    <section className='flex justify-between relative h-[80vh] items-end p-12'>
      ...
      <div className='relative'>
        ...
        <p className='mt-4 max-w-sm text-base text-white'>
          Поможем подобрать люстру под ваш <br /> интерьер, чтобы в доме было светло, <br /> уютно и
          комфортно каждый день.
        </p>
      </div>
