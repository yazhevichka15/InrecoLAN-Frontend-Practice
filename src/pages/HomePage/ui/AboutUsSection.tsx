        ...
        <div className='flex justify-between flex-1 flex-col'>
          <div>
            ...
            <p className='text-lg max-w-lg'>
              Сегодня «Империя люстр» это профессиональное обслуживание, высочайшего европейского
              качества. У нас Вы сможете подобрать красивые и недорогие люстры.
            </p>
          </div>
      ...
      <div className='flex justify-between gap-12 pt-10'>
        <div className='flex flex-1 flex-col items-start'>
          ...
          <p className='text-sm max-w-xs'>
            Четверть века превращаем комнаты в сияющие залы. Стили приходят и уходят, но мы всегда
            знаем, какой свет сделает вашу комнату особенной.
          </p>
        </div>
        <div className='flex flex-1 flex-col items-start'>
          ...
          <div className='h-px w-24 mb-4'></div>
          <p className='text-sm max-w-xs'>
            Мы уверены в качестве наших люстр как в своей правоте. Поэтому даем расширенную гарантию
            — целый год. Это наш знак качества и залог вашего спокойствия.
          </p>
        </div>
        <div className='flex flex-1 flex-col items-start'>
          <p className='text-5xl font-bold'>
          ...
          <div className='h-px w-24 mb-4'></div>
          <p className='text-sm max-w-xs'>
            Мы привыкли работать на результат: если вы ушли от нас с улыбкой — значит, мы
            справились.
          </p>
        </div>
      </div>
